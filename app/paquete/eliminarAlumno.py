...
class MiFrame(ctk.CTkFrame):
	def __init__(self,master,**kwargs):
		...
		etiqueta(self,"Eliminar estudiante","white",50,-1,-1,200,20,"w")
		...
		boton(self,"Eliminar",40,c.verdeFuerte,c.verdeClaro,100,10,self.eliminarAlumno,-1,-1,530,400,-1)
	...
	def eliminarAlumno(self):
		eliminarEstudiante(self.campoBoleta.get())
